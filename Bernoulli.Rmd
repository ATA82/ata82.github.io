...
Imagine you’re trying to determine whether a particular bacterium can survive a 
certain antibiotic. You place one bacterium in a petri dish with the antibiotic 
and wait: will it survive (**success**, coded as 1), or will it not survive 
(**failure**, coded as 0)? Each experiment like this is called a**Bernoulli trial**—
an event with just two possible outcomes.
